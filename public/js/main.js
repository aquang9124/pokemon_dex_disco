...
exports.default = {
    ...
    created: function created() {
        this.$http.get('http://pokeapi.co/api/v2/ability/' + this.poke_perm).then(function (res) {
            console.log(res);
            console.log(this.poke_perm);
        });
    }
};
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div class=\"panel-group\" id=\"accordion\">\n    <div class=\"panel panel-default\" v-for=\"abilities in poke_info.abilities\">\n        <div class=\"panel-heading\">\n            <h4 class=\"panel-title text-center\">\n                <a data-toggle=\"collapse\" data-parent=\"#accordion\" :href=\"collapseElement\">\n                    @{{ abilities.ability.name | uppercase }}\n                </a>\n            </h4>\n        </div>\n        <div class=\"panel-collapse collapse in\">\n            <div class=\"panel-body\">\n                \n            </div>\n        </div>\n    </div>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/alexquang/Code/2proj/resources/assets/js/components/Abilities.vue"
  if (!module.hot.data) {
...
var _Abilities = require('./components/Abilities.vue');
...
new Vue({
	...
	components: { Abilities: _Abilities2.default },
...
},{"./components/Abilities.vue":28,"vue":27,"vue-resource":16}]},{},[29]);
